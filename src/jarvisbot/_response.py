...
from ._exceptions import JarvisBotError, APIResponseValidationError
...
class MissingStreamClassError(TypeError):
    def __init__(self) -> None:
        super().__init__(
            "The `stream` argument was set to `True` but the `stream_cls` argument was not given. See `JarvisBot._streaming` for reference",
        )


class StreamAlreadyConsumed(JarvisBotError):
    """
